Contributing to DOMO Core
============================

The DOMO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DOMO Core project, and is not to be
confused with overall DOMO Network Protocol consensus changes.

Whether a pull request is merged into DOMO Core rests with the project merge
...
Patches that change DOMO consensus rules are considerably more involved than
...
Where a patch set proposes to change the DOMO consensus, it must have been
...
The project leader is the release manager for each DOMO Core release.
