...
In order to support loading of multiple wallets in domo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is domo.cpp.
...
Changes to domo.cpp
----------------------
domo.cpp is the entry point into domo-qt, and as such, will require some minor modifications to provide hooks for
