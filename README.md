...
Domocoin is an experimental new digital currency that enables instant payments to
anyone, anywhere in the world. Domocoin uses peer-to-peer technology to operate
...
Domocoin Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
If it is a simple/trivial/non-controversial change, then one of the Domocoin
...
Run with the -testnet option to run with "play Domocoins" on the test network, if you
...
Domocoin Core is a multithreaded application, and deadlocks or other multithreading bugs
