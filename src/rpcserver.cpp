...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DOMO features */
        {"domo", "masternode", &masternode, true, true, false},
        {"domo", "listmasternodes", &listmasternodes, true, true, false},
        {"domo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"domo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"domo", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"domo", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"domo", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"domo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"domo", "masternodedebug", &masternodedebug, true, true, false},
        {"domo", "startmasternode", &startmasternode, true, true, false},
        {"domo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"domo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"domo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"domo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"domo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"domo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"domo", "mnbudget", &mnbudget, true, true, false},
        {"domo", "preparebudget", &preparebudget, true, true, false},
        {"domo", "submitbudget", &submitbudget, true, true, false},
        {"domo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"domo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"domo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"domo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"domo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"domo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"domo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"domo", "checkbudgets", &checkbudgets, true, true, false},
        {"domo", "mnsync", &mnsync, true, true, false},
        {"domo", "spork", &spork, true, true, false},
        {"domo", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> domo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41993/\n";
}
