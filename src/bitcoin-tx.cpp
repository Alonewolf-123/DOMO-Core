...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Domocoin Core Domocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Domocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Domocoin transaction") + "\n" +
              "  Domocoin-tx [options] -create [commands]   " + _("Create hex-encoded Domocoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Domocoin transaction
