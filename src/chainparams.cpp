...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (50, uint256("000000ae3d528dcf44962445cd9a0eaa9fa0c2e718fb0b92f06c6c0c3c0a9bc1"))
    (2000, uint256("d9caf7bbd2f0d447bda15d7a8d56aa16aa7c9b8bc6c21b29307ebed70278e2c6")) //first block to use modifierV2
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 41992;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // DOMO starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DOMO: 1 day
        nTargetSpacing = 1 * 30;  // DOMO: 1 minute
        nMaturity = 30;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "DOMO Genesis Block: 2018/09/05 12:00:00";
        ...
        genesis.nNonce = 97637;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007f6af1bb16686d12e43ae9a94f0c036be7d813721c6c643eaac3de7fd12"));
        assert(genesis.hashMerkleRoot == uint256("0x5d7eff8adb0c707045a560d453d36fac83890cadf31f224c4f357464d6530311"));

        // vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "domo.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        // vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "domo.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "domo-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "domo-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 90); // Testnet domo addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 199);  // Testnet domo script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 247);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet domo BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet domo BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet domo BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // DOMO: 1 day
        nTargetSpacing = 1 * 60;        // DOMO: 1 minutes
