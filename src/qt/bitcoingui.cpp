                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DOMO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DOMO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and domo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDOMO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DOMO Core"), this);
    aboutAction->setStatusTip(tr("Show information about DOMO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DOMO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DOMO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DOMO addresses"));
    ...
    openAction->setStatusTip(tr("Open a DOMO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DOMO Core help message to get a list with possible DOMO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DOMO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DOMO network", "", count));
}
...
{
    QString strTitle = tr("DOMO Core"); // default title
