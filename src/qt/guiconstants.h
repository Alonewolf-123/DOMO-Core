...
/* Domo GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DOMO"
#define QAPP_ORG_DOMAIN "domo.org"
#define QAPP_APP_NAME_DEFAULT "DOMO-Qt"
#define QAPP_APP_NAME_TESTNET "DOMO-Qt-testnet"
