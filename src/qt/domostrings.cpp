...
#define UNUSED
#endif
static const char UNUSED *domo_strings[] = {
QT_TRANSLATE_NOOP("domo-core", " mints deleted\n"),
QT_TRANSLATE_NOOP("domo-core", " mints updated, "),
QT_TRANSLATE_NOOP("domo-core", " unconfirmed transactions removed\n"),
...
QT_TRANSLATE_NOOP("domo-core", ""
"Cannot obtain a lock on data directory %s. DOMO Core is probably already "
"running."),
QT_TRANSLATE_NOOP("domo-core", ""
...
QT_TRANSLATE_NOOP("domo-core", ""
"Disable all DOMO specific functionality (Masternodes, Zerocoin, SwiftX, "
...
"your clock is wrong DOMO Core will not work properly."),
QT_TRANSLATE_NOOP("domo-core", ""
...
QT_TRANSLATE_NOOP("domo-core", "(41992 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("domo-core", "(default: %s)"),
QT_TRANSLATE_NOOP("domo-core", "(default: 1)"),
QT_TRANSLATE_NOOP("domo-core", "(must be 41992 for mainnet)"),
...
QT_TRANSLATE_NOOP("domo-core", "Disable safemode, override a real safe mode event (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Discover own IP address (default: 1 when listening and no -externalip)"),
QT_TRANSLATE_NOOP("domo-core", "Display the stake modifier calculations in the debug.log file."),
QT_TRANSLATE_NOOP("domo-core", "Display verbose coin stake messages in the debug.log file."),
QT_TRANSLATE_NOOP("domo-core", "Do not load the wallet and disable wallet RPC calls"),
...
QT_TRANSLATE_NOOP("domo-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("domo-core", "Enable publish raw transaction (locked via SwiftX) in <address>"),
...
QT_TRANSLATE_NOOP("domo-core", "Error loading wallet.dat"),
QT_TRANSLATE_NOOP("domo-core", "Error loading wallet.dat: Wallet corrupted"),
QT_TRANSLATE_NOOP("domo-core", "Error loading wallet.dat: Wallet requires newer version of DOMO Core"),
QT_TRANSLATE_NOOP("domo-core", "Error opening block database"),
QT_TRANSLATE_NOOP("domo-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("domo-core", "Error recovering public key."),
QT_TRANSLATE_NOOP("domo-core", "Error writing zerocoinDB to disk"),
...
QT_TRANSLATE_NOOP("domo-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("domo-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("domo-core", "Invalid amount for -mintxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("domo-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("domo-core", "Invalid amount for -paytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("domo-core", "Invalid amount for -reservebalance=<amount>"),
QT_TRANSLATE_NOOP("domo-core", "Invalid amount"),
QT_TRANSLATE_NOOP("domo-core", "Invalid masternodeprivkey. Please see documenation."),
...
QT_TRANSLATE_NOOP("domo-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Loading addresses..."),
QT_TRANSLATE_NOOP("domo-core", "Loading block index..."),
QT_TRANSLATE_NOOP("domo-core", "Loading budget cache..."),
QT_TRANSLATE_NOOP("domo-core", "Loading masternode cache..."),
QT_TRANSLATE_NOOP("domo-core", "Loading masternode payment cache..."),
QT_TRANSLATE_NOOP("domo-core", "Loading sporks..."),
...
QT_TRANSLATE_NOOP("domo-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("domo-core", "Percentage of automatically minted Zerocoin  (1-100, default: %u)"),
...
QT_TRANSLATE_NOOP("domo-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Rescan the block chain for missing wallet transactions"),
QT_TRANSLATE_NOOP("domo-core", "Rescanning..."),
QT_TRANSLATE_NOOP("domo-core", "ResetMintZerocoin finished: "),
QT_TRANSLATE_NOOP("domo-core", "ResetSpentZerocoin finished: "),
QT_TRANSLATE_NOOP("domo-core", "Run a thread to flush wallet periodically (default: %u)"),
...
QT_TRANSLATE_NOOP("domo-core", "Set key pool size to <n> (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("domo-core", "Set minimum block size in bytes (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Set the Maximum reorg depth (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("domo-core", "Set the number of threads to service RPC calls (default: %d)"),
QT_TRANSLATE_NOOP("domo-core", "Sets the DB_PRIVATE flag in the wallet db environment (default: %u)"),
QT_TRANSLATE_NOOP("domo-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("domo-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("domo-core", "Signing failed."),
QT_TRANSLATE_NOOP("domo-core", "Signing timed out."),
QT_TRANSLATE_NOOP("domo-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("domo-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("domo-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("domo-core", "Specify data directory"),
QT_TRANSLATE_NOOP("domo-core", "Specify masternode configuration file (default: %s)"),
QT_TRANSLATE_NOOP("domo-core", "Specify pid file (default: %s)"),
QT_TRANSLATE_NOOP("domo-core", "Specify wallet file (within data directory)"),
QT_TRANSLATE_NOOP("domo-core", "Specify your own public address"),
QT_TRANSLATE_NOOP("domo-core", "Spend Valid"),
...
QT_TRANSLATE_NOOP("domo-core", "Synchronization pending..."),
QT_TRANSLATE_NOOP("domo-core", "Synchronizing budgets..."),
...
QT_TRANSLATE_NOOP("domo-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("domo-core", "Transaction Created"),
...
QT_TRANSLATE_NOOP("domo-core", "Warning"),
