...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Domocoin Core"),
     ...
     * override -datadir in the Domocoin.conf file in the default data directory
     * (to be consistent with Domocoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
