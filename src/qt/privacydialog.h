...
public:
    ...
    void setZDomoControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDOMO_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDOMO_clicked();
    void on_pushButtonZDomoControl_clicked();
